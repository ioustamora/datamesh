    ...
    for size in data_sizes {
        ...
        group.bench_with_input(BenchmarkId::new("encrypt", size), &mut data, |b, data| {
            b.iter(|| {
                ...
                let tag = cipher
                    .encrypt_in_place_detached(black_box(nonce), b"", &mut buffer)
                    .unwrap();
        ...
        let tag = cipher
            .encrypt_in_place_detached(nonce, b"", &mut encrypted_data)
            .unwrap();
        ...
        group.bench_with_input(
            ...
            |b, (encrypted_data, tag)| {
                b.iter(|| {
                    ...
                    cipher
                        .decrypt_in_place_detached(black_box(nonce), b"", &mut buffer, tag)
                        .unwrap();
                    black_box(buffer);
                });
            },
