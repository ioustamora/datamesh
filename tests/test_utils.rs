/// Test Utilities for DataMesh - Consolidated Version
///
/// This module provides common utilities and setup functions for testing,
/// improving test reliability and reducing code duplication. This replaces
/// all previous test utility variations.
...
impl TestEnvironment {
    pub fn new() -> Result<Self> {
        ...
        let test_key = ecies::SecretKey::parse(&[1u8; 32]).unwrap();
    ...
    pub fn create_test_config(&self) -> Config {
        ...
        config.storage.keys_dir = Some(self.temp_dir.path().join("keys"));
        config
    }
}
