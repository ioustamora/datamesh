...
impl NetworkPresets {
    ...
    pub fn new() -> Self {
        ...
        presets.insert("local".to_string(), NetworkPreset {
        ...
        presets.insert("public".to_string(), NetworkPreset {
        ...
        // Testing preset
        presets.insert("test".to_string(), NetworkPreset {
            name: "test".to_string(),
    ...
    pub fn apply_preset(&self, preset_name: &str) -> Result<ConnectionConfig> {
        ...
        ui::print_info(&format!("Using '{}' network preset: {}", preset.name, preset.description));
        ...
        for bootstrap_peer in &preset.bootstrap_peers {
            ...
            } else if bootstrap_peer.peer_id != "example" { // Skip example entries
    ...
    pub fn save_custom_preset(&self, name: &str, preset: NetworkPreset) -> Result<()> {
        ...
        ui::print_success(&format!("Saved custom preset '{}' to {:?}", name, presets_file));
        Ok(())
    }
}
